...
<head>
    @include('admin.head')
    <title>Daftar Pengumuman (Admin)</title>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle text-center">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('admin.pengumuman.edit', $item->pengumuman_id) }}" class="btn btn-sm btn-edit d-flex align-items-center">
                                                <i class="bi bi-pencil-square me-1"></i> Edit
                                            </a>
                                            <form action="{{ route('admin.pengumuman.destroy', $item->pengumuman_id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengumuman ini?')">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="5">Tidak ada data pengumuman.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
